DROP TABLE IF EXISTS purchase.licenses;

CREATE TABLE purchase.licenses (
...
INSERT INTO purchase.licenses (license_id,  organization_id, license_type, product_name, license_max, license_allocated)
